...
if __name__ == '__main__':
    ...
    task_3 = HpLoopedTask(TASK_3_NAME, tc.task_3_func, interval=1)
    ...
    print('2 - All tasks finished: ', ltm._data_manager.all_task_finished())
    print('2 - Abort flag: ', ltm._data_manager.get_abort_flag())