...
CREATE INDEX "MDCommMessage_robot_info_fk" ON {schema_name}.{comm_msg_table_name} USING btree ({msg_foreign_key_column_name});


ALTER TABLE {schema_name}.{comm_msg_table_name} 
	ADD CONSTRAINT comm_message_robot_id_fkey FOREIGN KEY ({msg_foreign_key_column_name}) 
