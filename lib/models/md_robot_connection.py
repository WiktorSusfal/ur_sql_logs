...
class MdRobotConnection:
    ...
    def __init__(self, id: str = None, connection_data: DsRobotConnectionData = None):
        ...
        self._update_data(connection_data or DsRobotConnectionData())

    @property
    def id(self) -> str:
        return self._id
    
    def _update_data(self, data: DsRobotConnectionData):
    ...
    def produce_data_struct(self) -> DsRobotConnectionData:
        return DsRobotConnectionData(self._name, self._ip_address, self._port, self._read_freq)